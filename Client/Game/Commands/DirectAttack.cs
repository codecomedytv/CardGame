...
namespace CardGame.Client.Game
{
    public class DirectAttack: Command
    {
        ...
        protected override void SetUp(Effects gfx)
        {
            ...
            gfx.InterpolateProperty(Attacker, "translation", Attacker.Translation, destination, 0.1F);
            gfx.InterpolateProperty(Attacker, "translation", destination, Attacker.Translation, 0.1F,
